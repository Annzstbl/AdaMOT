...
class ada_opts(object):
    def __init__(self):
        ...
        self.parser.add_argument('--lr_step', type=str, default='25',
                                 help='drop learning rate by 10.')

        self.parser.add_argument('--warm_up', action='store_true', default=False)
        self.parser.add_argument('--warmup_step', type=int, default=221)

        self.parser.add_argument('--id_aware', action='store_true', default=False)
        self.parser.add_argument('--load_id_net', default='',
                                 help='path to pretrained model')
        ...
        self.parser.add_argument('--pos', type=int, default=9)
        ...
        self.parser.add_argument('--keep_res', action='store_true',
                                 help='keep the original resolution'
                                      ' during validation.')
        self.parser.add_argument('--no_nms', action='store_true', default=False)
        ...
        self.parser.add_argument('--val_mot20min', default=False, help='val mot20min')
        ...
        self.parser.add_argument('--data_dir', type=str, default='/root/autodl-tmp')
