...
cd ~/AdaMOT
python ada_train.py --task ada_mot --exp_id crowdhuman_dla34 --gpus 0 --load_model './models/ctdet_coco_dla_2x.pth' --data_cfg './src/lib/cfg/crowdhuman.json' --print_iter 1 --batch_size 4